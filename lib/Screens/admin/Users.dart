...
class _UsersState extends State<Users> {
                              ...
                              itemBuilder: (context, index) {
                                  ...
                                  if (name.value == user['username']) {
                                    ...
                                    if (worker == "false") {
                                      ...
                                      final req = await http.put(Uri.parse(
                                          "http://192.168.160.248:8000/worker/${real_index}"));
                                      ...
                                      final real_index = updated_user['id'];
                                      final req = await http.put(Uri.parse(
                                          "http://192.168.160.248:8000/not_worker/${real_index}"));
                                      final req2 = await http.put(Uri.parse(
                                          "http://192.168.160.248:8000/not_admin/${real_index}"));
                                ...
                                Future Update(int status, String admin) async {
                                  if (name.value == user['username']) {
                                    ...
                                    if (admin == "false") {
                                      ...
                                      final real_index = updated_user['id'];
                                      final req = await http.put(Uri.parse(
                                          "http://192.168.160.248:8000/admin/${real_index}"));
                                ...
                                Delete(int status) async {
                                  final response = await http.post(Uri.parse(
                                      "http://192.168.160.248:8000/user/${user_id.value}"));
                                  ...
                                  if (response.statusCode == 200) {
                                    ...
                                    if (result['username'] ==
                                      ...
                                      final req = await http.delete(Uri.parse(
                                          "http://192.168.160.248:8000/del_user/${real_index}"));
  ...
  Future<void> fetchUsers() async {
    try {
      final url = Uri.parse("http://192.168.160.248:8000/users");
